...
MY_FLOAT **taylor_coefficients_3bp(MY_FLOAT t, MY_FLOAT *x, int order);

MY_FLOAT **taylor_coefficients_3bpA(MY_FLOAT t, MY_FLOAT *x, int order, int reuse_last_computation);
int       taylor_step_3bp(MY_FLOAT *ti, MY_FLOAT *x, int dir, int step_ctl,
