...
int taylor_step_lrnz(MY_FLOAT *ti,
                 MY_FLOAT *x,
                 int      dir,
                 int      step_ctl,
                 double   log10abserr,
 ...
 * 1: ok, and ti=endtime.  */
{
  MY_FLOAT **taylor_coefficients_lrnz(MY_FLOAT, MY_FLOAT*, int);
  MY_FLOAT **taylor_coefficients_lrnzA(MY_FLOAT, MY_FLOAT*, int, int);
  int compute_order_1_lrnz(double, double, double, int*);
  int comp_order_other_lrnz(double, double, double);
  double compute_stepsize_1_lrnz(MY_FLOAT**, int, double, int);
  double compute_stepsize_2_lrnz(MY_FLOAT**, int, double, int);
  double comp_stepsize_other_lrnz(MY_FLOAT**, int, int, double, double, double);
...
*/
  switch(step_ctl)
    ...
    case 0: /* no step size control, fixed degree; both given by the user */
      ...
      break;
    case 1:
      nt=compute_order_1_lrnz(xnorm,log10abserr,log10relerr,&flag_err);
      break;
    case 2:
      nt=compute_order_1_lrnz(xnorm,log10abserr,log10relerr,&flag_err);
      break;
    case 3:
      nt=comp_order_other_lrnz(xnorm,log10abserr,log10relerr);
      break;
    default:
...
*/
  if(step_ctl != 0) {
    s=taylor_coefficients_lrnzA(*ti,x,nt,1);
  } else {
    s=taylor_coefficients_lrnz(*ti,x,nt); 
 }
...
*/
  switch(step_ctl)
    ...
    case 0: /* no step size control (fixed step size, given by the user) */
      ...
      break;
    case 1:
      dh=compute_stepsize_1_lrnz(s,nt,xnorm,flag_err);
      MakeMyFloatA(h, dh);
      break;
    case 2:
      dh=compute_stepsize_2_lrnz(s,nt,xnorm,flag_err);
      MakeMyFloatA(h, dh);
      break;
    case 3:
      dh=comp_stepsize_other_lrnz(s,_N_DIM_,nt,xnorm,log10abserr,log10relerr);
      MakeMyFloatA(h, dh);
      break;
    default:
      fprintf(stderr, "taylor_step: undefined step size control.\n");
...
int compute_order_1_lrnz(double xnorm, double log10abserr, double log10relerr, int* flag_err)
/*
...
double compute_stepsize_1_lrnz(MY_FLOAT **s, int nt, double xnorm, int flag_err)
/*
 ...
 */
{
  double double_log_MyFloat_lrnz(MY_FLOAT x);
...
*/
  if (MyFloatA_LE_B(v1,of) && MyFloatA_GE_B(v1,uf))
    ...
    {
      lnv1=double_log_MyFloat_lrnz(v1);
    }
  if (MyFloatA_LE_B(v2,of) && MyFloatA_GE_B(v2,uf))
    ...
    {
      lnv2=double_log_MyFloat_lrnz(v2);
    }
/*
...
double compute_stepsize_2_lrnz(MY_FLOAT **s, int nt, double xnorm, int flag_err)
/*
 * it looks for a step size for an expansion up to order nt. this
 * function requires that nt is the value computed by
...
int comp_order_other_lrnz(double lnxnorm, double log10abserr, double log10relerr){
  puts("---");
...
double comp_stepsize_other_lrnz(MY_FLOAT **s, int nd, int nt, double xnorm, double log10abserr, double log10relerr) {
...
#include <stdio.h>
#include <stdlib.h>
MY_FLOAT **taylor_coefficients_lrnzA(MY_FLOAT t, MY_FLOAT *x, int order, int rflag)
{
   /* input: 
...
MY_FLOAT **taylor_coefficients_lrnz(MY_FLOAT t, MY_FLOAT *x, int order)
{
    return(taylor_coefficients_lrnzA(t,x,order,0));
}
...
===================================================================================
	...
	c_054 = 11.0                                     (2 0)
	c_090 = (-c_054)                                 (3 0)
	c_091 = (c_049^c_090)                            (4 0)
	c_092 = (c_052*c_091)                            (5 0)
	c_056 = 5.97237                                  (6 0)
	c_058 = 15.0                                     (7 0)
	c_093 = (c_049^c_058)                            (8 0)
	c_094 = (c_056*c_093)                            (9 0)
	c_095 = (c_092*c_094)                            (10 0)
	v_096 = (v_037-v_034)                            (12 0)
	v_097 = (c_095*v_096)                            (13 0)
	c_060 = 3.0                                      (11 0)
	v_099 = (v_096^c_060)                            (14 0)
	v_100 = abs(v_099)                               (15 0)
	v_101 = (v_097/v_100)                            (16 0)
	v_103 = (v_038-v_035)                            (17 0)
	v_104 = (c_095*v_103)                            (18 0)
	v_106 = (v_103^c_060)                            (19 0)
	v_107 = abs(v_106)                               (20 0)
	v_108 = (v_104/v_107)                            (21 0)
	v_110 = (v_039-v_036)                            (22 0)
	v_111 = (c_095*v_110)                            (23 0)
	v_113 = (v_110^c_060)                            (24 0)
	v_114 = abs(v_113)                               (25 0)
	v_115 = (v_111/v_114)                            (26 0)
	c_048 = 1.98848                                  (12 0)
	c_050 = 21.0                                     (13 0)
	c_088 = (c_049^c_050)                            (14 0)
	c_089 = (c_048*c_088)                            (15 0)
	c_116 = (c_089*c_092)                            (16 0)
	v_118 = (c_116*v_096)                            (27 0)
	v_119 = (v_034-v_037)                            (28 0)
	v_120 = (v_119^c_060)                            (29 0)
	v_121 = abs(v_120)                               (30 0)
	v_122 = (v_118/v_121)                            (31 0)
	v_125 = (c_116*v_103)                            (32 0)
	v_126 = (v_035-v_038)                            (33 0)
	v_127 = (v_126^c_060)                            (34 0)
	v_128 = abs(v_127)                               (35 0)
	v_129 = (v_125/v_128)                            (36 0)
	v_132 = (c_116*v_110)                            (37 0)
	v_133 = (v_036-v_039)                            (38 0)
	v_134 = (v_133^c_060)                            (39 0)
	v_135 = abs(v_134)                               (40 0)
	v_136 = (v_132/v_135)                            (41 0)
===================================================================
=========                                                  ========
